...
Mean lobster size differed significantly between MPA and non-MPA sites in 2012 for the sites sampled (t(`r round(lobster_2012_ttest$parameter, 2)`) = `r round(lobster_2012_ttest$statistic, 2)`, *p* < 0.01). 
