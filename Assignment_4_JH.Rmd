...
```{r}
# Create color vectors for MPA/non-MPA variable in graph
...
Mean lobster size differed significantly between MPA sites in 2012 and 2018 (t(`r round(mpa_2012_2018_ttest$parameter, 2)`) = `r round(mpa_2012_2018_ttest$statistic, 2)`, *p* < 0.001) with a large effect size (Cohen's *d* = `r round(d_12_18_mpa$estimate, 2)`). 
...
- Lobster abundance does not seem to be affected by the MPA status of a site. 
...
- Mean lobster sizes were much larger in MPA sites than they were in non-MPA sites. This difference was nearly twice as great in 2012 as it was in 2018. 
