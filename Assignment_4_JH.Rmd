...
```{r}
# Statistics analysis data frames
...
mean_nonmpa_2018 <- mean(nonmpa_2018$size_mm)
...
sd_nonmpa_2018 <- sd(nonmpa_2018$size_mm)
...
```{r}
# Make the table of lobster sample statistics:
...
lobster_summary_table %>% 
  ...
  kable_styling(bootstrap_options = "striped", "hover", 
                ...
                row_spec(c(1,3), 
                         ...
                         color = "white", 
                         background = "blue") %>% 
  add_header_above(c("Lobster Size Statistics" = 5))
...
Mean lobster size in MPA sites sampled in 2012 (`r round(mean_mpa_2012, 2)` $\pm$ `r round(sd_mpa_2012, 2)`, n = `r n_mpa_2012`) differed significantly from lobsters sampled in non-MPA sites in 2012 (`r round(mean_nonmpa_2012, 2)` $\pm$ `r round(sd_nonmpa_2012, 2)`, n = `r n_nonmpa_2012`) by a two-sided t-test (t(`r round(lobster_2012_ttest$parameter, 2)`) = `r round(lobster_2012_ttest$statistic, 2)`, *p* < 0.01). 
...
Mean lobster size differed significantly between MPA and non-MPA sites in 2018 for the sites sampled (t(`r round(lobster_2018_ttest$parameter, 2)`) = `r round(lobster_2018_ttest$statistic, 2)`, *p* < 0.001). 
...
Mean lobster size differed significantly between MPA and non-MPA sites in 2018 for the sites sampled (t(`r round(mpa_2012_2018_ttest$parameter, 2)`) = `r round(mpa_2012_2018_ttest$statistic, 2)`, *p* < 0.001). 
...
There is not enough evidence to conclude that mean lobster size was significantly different in non-MPA sites in 2012 vs. 2018 (t(`r round(nonmpa_2012_2018_ttest$parameter, 2)`) = `r round(nonmpa_2012_2018_ttest$statistic, 2)`, *p* > 0.05). 
